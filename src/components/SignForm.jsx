...
const SignForm = ({ setSupabaseError, setRegistrado }) => {
    const {
        handleSubmit,
        register,
    ...
    return (
        <form onSubmit={handleSubmit(registrar)}>
            ...
            <FormControl mt="1.25rem" isInvalid={errors.email}>
            ...
            <FormControl mt="1.25rem" isInvalid={errors.confirmarPassword}>
            ...
            <FormControl mt="1.25rem" isInvalid={errors.terms}>
